...
const ICON_RECORD_BUTTON = new Icon(require('./assets/images/record_button1x.png'), 70, 119);
const ICON_RECORDING = new Icon(require('./assets/images/record_icon1x.png'), 20, 14);

const ICON_PLAY_BUTTON = new Icon(require('./assets/images/play_button1x.png'), 34, 51);
const ICON_PAUSE_BUTTON = new Icon(require('./assets/images/pause_button1x.png'), 34, 51);
const ICON_STOP_BUTTON = new Icon(require('./assets/images/stop_button1x.png'), 22, 22);

const ICON_MUTED_BUTTON = new Icon(require('./assets/images/muted_button1x.png'), 67, 58);
const ICON_UNMUTED_BUTTON = new Icon(require('./assets/images/unmuted_button1x.png'), 67, 58);
